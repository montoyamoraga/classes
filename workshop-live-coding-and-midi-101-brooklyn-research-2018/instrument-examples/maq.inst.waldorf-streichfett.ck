...
function void sendNote() {
    ...
    //use 0-127 on waldorf streichfett for selecting notes
    Std.rand2(0,127) => msg.data2;
    //when data1 is 144, data3 is velocity
    //use 0-127 on waldorf streichfett for selecting velocity
    6 => msg.data3;
...
function void controlChange() {
    ...
    //use 1, 64, 70-82, 91-94, 120-123 on waldorf streichfett
    //1 is modulation wheel
    1 => msg.data2;
    //when data1 is 176, data3 is controller value
    //use 0-127 on waldorf streichfett for selecting value
